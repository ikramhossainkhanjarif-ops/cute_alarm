...
3. A custom alarm sound (placeholder gentle chime included, generated
   programmatically — swap with your own `.mp3`).
...
- **Alarm sound:** replace `assets/sounds/alarm_sound.mp3` with your own
  track. Keep it reasonably short — it loops automatically while ringing.
